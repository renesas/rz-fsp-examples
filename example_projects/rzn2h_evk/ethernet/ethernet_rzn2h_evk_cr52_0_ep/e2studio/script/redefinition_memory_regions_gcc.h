...
CPU0_ATCM_VIA_AXIS_PRV_START  = DEFINED(CPU0_ATCM_VIA_AXIS_START) ? CPU0_ATCM_VIA_AXIS_START : 0;
CPU0_ATCM_VIA_AXIS_PRV_LENGTH = DEFINED(CPU0_ATCM_VIA_AXIS_LENGTH) ? CPU0_ATCM_VIA_AXIS_LENGTH : 0;
CPU0_BTCM_VIA_AXIS_PRV_START  = DEFINED(CPU0_BTCM_VIA_AXIS_START) ? CPU0_BTCM_VIA_AXIS_START : 0;
CPU0_BTCM_VIA_AXIS_PRV_LENGTH = DEFINED(CPU0_BTCM_VIA_AXIS_LENGTH) ? CPU0_BTCM_VIA_AXIS_LENGTH : 0;
CPU1_ATCM_VIA_AXIS_PRV_START  = DEFINED(CPU1_ATCM_VIA_AXIS_START) ? CPU1_ATCM_VIA_AXIS_START : 0;
CPU1_ATCM_VIA_AXIS_PRV_LENGTH = DEFINED(CPU1_ATCM_VIA_AXIS_LENGTH) ? CPU1_ATCM_VIA_AXIS_LENGTH : 0;
CPU1_BTCM_VIA_AXIS_PRV_START  = DEFINED(CPU1_BTCM_VIA_AXIS_START) ? CPU1_BTCM_VIA_AXIS_START : 0;
CPU1_BTCM_VIA_AXIS_PRV_LENGTH = DEFINED(CPU1_BTCM_VIA_AXIS_LENGTH) ? CPU1_BTCM_VIA_AXIS_LENGTH : 0;
...
DDR_MIRROR0_PRV_LENGTH = DEFINED(DDR_MIRROR0_LENGTH) ?
                         DEFINED(DDR_MIRROR0_CR52_0_LENGTH) ? (MAX(DDR_MIRROR0_LENGTH, DDR_MIRROR0_CR52_0_LENGTH) - DDR_MIRROR0_CR52_0_LENGTH) :
                         DEFINED(DDR_MIRROR0_CR52_1_LENGTH) ? (MAX(DDR_MIRROR0_LENGTH, DDR_MIRROR0_CR52_1_LENGTH) - DDR_MIRROR0_CR52_1_LENGTH) :
                         DDR_MIRROR0_LENGTH : 0;

DDR_MIRROR1_PRV_START = DEFINED(DDR_MIRROR1_START) ?
                        DEFINED(DDR_MIRROR1_CA55_0_START) ? 0 :
                        DEFINED(DDR_MIRROR1_CA55_1_START) ? 0 :
                        DEFINED(DDR_MIRROR1_CA55_2_START) ? 0 :
                        DEFINED(DDR_MIRROR1_CA55_3_START) ? 0 :
                        DEFINED(DDR_MIRROR0_START) ? MAX(DDR_MIRROR0_START, DDR_MIRROR1_START) :
                        DDR_MIRROR1_START : 0;
DDR_MIRROR1_PRV_LENGTH = DEFINED(DDR_MIRROR1_LENGTH) ?
                         DEFINED(DDR_MIRROR1_CA55_0_LENGTH) ? 0 :
                         DEFINED(DDR_MIRROR1_CA55_1_LENGTH) ? 0 :
                         DEFINED(DDR_MIRROR1_CA55_2_LENGTH) ? 0 :
                         DEFINED(DDR_MIRROR1_CA55_3_LENGTH) ? 0 :
                         DEFINED(DDR_MIRROR0_LENGTH) ? MIN(DDR_MIRROR0_LENGTH, DDR_MIRROR1_LENGTH) :
                         DDR_MIRROR1_LENGTH : 0;

DDR_PRV_START = DEFINED(DDR_START) ?
                DEFINED(DDR_CR52_0_START) ? 0 :
                DEFINED(DDR_CR52_1_START) ? 0 :
                DDR_START : 0;
DDR_PRV_LENGTH = DEFINED(DDR_LENGTH) ?
                 DEFINED(DDR_CR52_0_LENGTH) ? 0 :
                 DEFINED(DDR_CR52_1_LENGTH) ? 0 :
                 DDR_LENGTH : 0;

PCIE0_PRV_START = DEFINED(PCIE0_START) ?
                  DEFINED(PCIE0_CR52_0_START) ? 0 :
                  DEFINED(PCIE0_CR52_1_START) ? 0 :
                  PCIE0_START : 0;
PCIE0_PRV_LENGTH = DEFINED(PCIE0_LENGTH) ?
                   DEFINED(PCIE0_CR52_0_LENGTH) ? 0 :
                   DEFINED(PCIE0_CR52_1_LENGTH) ? 0 :
                   PCIE0_LENGTH : 0;
PCIE1_PRV_START = DEFINED(PCIE1_START) ?
                  DEFINED(PCIE1_CR52_0_START) ? 0 :
                  DEFINED(PCIE1_CR52_1_START) ? 0 :
                  PCIE1_START : 0;
PCIE1_PRV_LENGTH = DEFINED(PCIE1_LENGTH) ?
                   DEFINED(PCIE1_CR52_0_LENGTH) ? 0 :
                   DEFINED(PCIE1_CR52_1_LENGTH) ? 0 :
                   PCIE1_LENGTH : 0;
