...
1. Project Overview:
    ...
    RZ/N2H microprocessor. It counts pulses from a two-phase encoder (A phase, B phase) and provides RTT Viewer-based 
...
5. Hardware Connections:
    ...
    (4) Connect Two-phase encoder Phase A/B signal with GPT
