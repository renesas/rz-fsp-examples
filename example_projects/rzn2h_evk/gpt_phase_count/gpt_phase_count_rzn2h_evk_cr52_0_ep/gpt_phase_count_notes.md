...
This example project demonstrates basic functionalities of GPT drive in phase counting mode 1 on RZ/N2H based on Renesas FSP.
...
Result and GPT status are displayed on the J-Link RTTViewer.
...
## Verifying operation
1. Import, generate and build GPT PHASE COUNT EP in e2studio.
...
4. User can perform Menu option operations and check corresponding results J-Link RTTViewer.
5. Verify phase count direction by rotating the encoder shaft:
   ...
   Below images showcases the GPT output on J-Link RTTViewer:
