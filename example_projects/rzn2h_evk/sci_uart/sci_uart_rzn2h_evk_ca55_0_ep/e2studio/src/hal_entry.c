...
void hal_entry(void)
{
    ...
    char banner_info[600] = {RESET_VALUE};
    ...
    snprintf(banner_info, sizeof(banner_info), BANNER_INFO, EP_VERSION, version.version_id_b.major, version.version_id_b.minor, version.version_id_b.patch);

    /* Example project information printed on the Console */
    err = uart_print_user_msg((uint8_t *)banner_info); /* cast to uint8_t */
    uart_print_user_msg((uint8_t *)EP_INFO);
