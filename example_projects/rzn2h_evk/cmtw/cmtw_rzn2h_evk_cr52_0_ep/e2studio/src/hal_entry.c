...
void hal_entry(void)
{
    ...
    /* Initialize the CMTW module */
    err = R_CMTW_Open(&g_timer_ctrl, &g_timer_cfg);

    /* Handle error */
    if (FSP_SUCCESS != err)
    {
        /* CMTW module init failed */
        APP_PRINT("\r\n** R_CMTW_Open API failed **\r\n");
        APP_ERR_TRAP(err);
    }

    /* Start the timer */
    err = R_CMTW_Start(&g_timer_ctrl);

    /* Handle error */
    if (FSP_SUCCESS != err)
    {
        APP_PRINT("\r\n** R_CMTW_Start API failed **\r\n");
        APP_ERR_TRAP(err);
    }
...
/***********************************************************************************************************************
 * @brief     This function toggles all BSP LEDs and prints a log line.
