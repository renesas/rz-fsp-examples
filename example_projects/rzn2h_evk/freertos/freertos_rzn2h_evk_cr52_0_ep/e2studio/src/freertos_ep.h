...
/* Wait time for task on Semaphore and Message Queue */
#define WAIT_TIME                   (500u)
/* No of times the ISR executes total for a (TASK_SUSPEND_COUNT * timer period) second run time */
#define TASK_SUSPEND_COUNT          (10u)
