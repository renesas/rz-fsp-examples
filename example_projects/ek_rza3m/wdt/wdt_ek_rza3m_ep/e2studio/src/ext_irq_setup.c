...
/***********************************************************************************************************************
 * @brief       This function enables the User pushbutton and returns the error to the application.
 * @param[IN]   None.
 * @retval      FSP_SUCCESS                  Pushbutton enabled successfully.
 * @retval      Any other error code apart from FSP_SUCCESS  Unsuccessful to enable pushbutton.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       This function closes the IRQ HAL driver and handles the return closing API error.
 * @param[IN]   None.
 * @retval      None.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief      This functions is used to stop the GTM timer. It is called when user presses the push button.
