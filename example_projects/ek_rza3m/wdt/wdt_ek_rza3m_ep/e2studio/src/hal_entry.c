...
/* Function used to read TeraTerm input and proceed */
...
void hal_entry(void)
{
    ...
    while (true)
    {
         ...
         * This is done to avoid the continuous print message on Tera Term */
...
/***********************************************************************************************************************
 * @brief       This function reads user input from Tera Term using UART. Handle the error internally with
 *              Proper Message. Application handles the rest.
 * @param[IN]   None.
...
static void check_reset_status(void)
{
    ...
    if (R_CPG_CPG_WDTOVF_RST_WDTOVF0 == R_CPG->CPG_WDTOVF_RST_b.WDTOVF0)
    {
