...
/* I2C/SPI transfer size definitions */
#define ONE_BYTE                (0x01)
#define TWO_BYTE                (0x02)

/* Accelerometer register addresses and identification */
#define DEVICE_ID_REG           (0x00)
#define DEVICE_SIGNATURE        (0xE5)
#define POWER_CTL_REG           (0x2D)
#define AXIS_DATA               (0x32)

/* Accelerometer configuration and control parameters */
...
/* Sensor data handling definitions */
#define SENSOR_DATA_SIZE        (0x06)
#define BIT_SHIFT_8             (8u)


#define EP_INFO     "This Example Project utilizes PMOD ACL sensor as iic slave device\r\n"\
