...
static uint8_t g_master_buf[BUF_LEN] __attribute__((section("UNCACHED_BSS")));
...
/***********************************************************************************************************************
 * @brief     This function initializes IIC master and slave drivers.
 * @param[IN] None.
 ...
 *              else Turn LED ON to indicate failure.
...
static fsp_err_t iic_slave_read(void)
{
    ...
    /* Wait until slave read and master write processes complete */
...
/***********************************************************************************************************************
 * @brief     This function toggles on board LED, which are connected and supported by BSP.
 * @param[in] None.
 * @retval    None.
 **********************************************************************************************************************/
static void toggle_led(void)
...
/***********************************************************************************************************************
 * @brief     This function closes the IIC Master and Slave module. Handle the error internally with proper message.
