...
### Hardware
* Board RZ/A3M Evaluation Kit
* Cable USB A to USB C
* MIPI Graphics Expansion Board 2 Version 1 (APP_LCD_EK_MIPI_2)
...
| :-------------------------------------: | :---------------: | :------------: | :--------: |
|  Input > Graphics Layer 1  > General > Horizontal size | 1280 | 720 | Horizontal pixel value of LCD used for RZ/A3M is 720 |
|  Input > Graphics Layer 1  > General > Vertical size | 720 | 1280 | Vertical pixel value of LCD used for RZ/A3M is 1280 |
|  Input > Graphics Layer 1  > General > Color format | YCbCr422 interleaved YUYV(16 bit) | RGB565(16 bit) | The LCD board is designed in RGB565 format |
|  Input > Graphics Layer 1  > Framebuffer > Framebuffer name | fb_background | g_framebuffer | Better visualize and unify with RA GLCDC EP |
...
* Connect (DEBUG1) on Board RZ/A3M Evaluation Kit with PC through USB Type-C Connector
* Connect MIPI Graphics Expansion Board 2 Version 1 to RZ/A3M board

The below images showcase the output on Terminal Emulator:

<img src="images/LCDC_Log.png" alt="Terminal Emulator Log" title="LCDC_Log" width="500"/>

in the Memory Monitor view in e2 studio:

<img src="images/LCDC_raw_image_op.png" alt="LCDC Raw Image" title="LCDC_raw_image_op" width="500"/>

and in Display support HDMI port respectively:

<img src="images/LCDC_LCD_op.jpg" alt="LCDC LCD Output" title="LCDC_LCD_op" width="500"/>
