 ...
 * This data will be transmit to IOPORT P01 register,
 * which specifies the input/output states of a pin.
...
{
    fsp_err_t fsp_err = FSP_SUCCESS;    /* Variable to store FSP error codes */
     ...
     * Note: If the source and destination addresses are not set before
     * opening the transfer interface, the open operation will fail. */
    ...
    /* Display information about g_transfer_led_blink transfer on Tera Term and view the on-board LED */
...
/***********************************************************************************************************************
 *  @brief       This function transfers the MTU value.
 *  @param[IN]   None.
 *  @retval      None.
 **********************************************************************************************************************/
void transfer_mtu_value(void)
{
    ...
    /* Set the source and destination addresses for DMAC g_transfer_mtu_value.
     * Note: If the source and destination addresses are not set before
     * opening the transfer interface, the open operation will fail. */
