...
/* Flag variable for printing data on Tera Term */
...
fsp_err_t dmac_transfer_software_start(transfer_ctrl_t * const p_transfer_ctrl)
{
    ...
    if (FSP_SUCCESS != fsp_err)
    {
        APP_ERR_PRINT("\r\nR_DMAC_SoftwareStart API failed.\n");
    }
    return fsp_err;
}
...
/***********************************************************************************************************************
 *  @brief       This function sets the source and destination address for the DMAC transfer instance.
