...
/***********************************************************************************************************************
 * @brief       This function initializes the INTC_IRQ module.
 * @param[IN]   None.
...
fsp_err_t intc_irq_init(void)
{
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        APP_ERR_PRINT ("** R_INTC_IRQ_ExternalIrqOpen API failed **\r\n\r\n");
    }
    return err;
}
...
fsp_err_t intc_irq_enable(void)
{
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        APP_ERR_PRINT ("** R_INTC_IRQ_ExternalIrqEnable API failed **\r\n\r\n");
    }
    return err;
}
...
void intc_irq_deinit(void)
{
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        APP_ERR_PRINT("** R_INTC_IRQ_ExternalIrqClose API failed **\r\n\r\n");
    }
}
