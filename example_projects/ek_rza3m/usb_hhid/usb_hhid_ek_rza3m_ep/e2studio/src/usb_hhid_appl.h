 ...
 * Description  : Contains declarations of data structures and functions used in usb_app_thread_entry.c.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define EP_INFO     "This example project demonstrates basic functionalities of USB Host Human\r\n"\
                    "Interface Device. Class (HHID) driver with FreeRTOS on Renesas RZA3M MPU\r\n"\
