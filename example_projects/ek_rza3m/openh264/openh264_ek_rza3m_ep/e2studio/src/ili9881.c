/***********************************************************************************************************************
 * File Name    : ili9881.c
 * Description  : Contains declarations of data structures used in ili9881.c
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
/*****************************************************************************************************************
 *  @brief      This function initializes of ili9881 device.
 *  @param[in]  None.
 *  @retval     None.
 ****************************************************************************************************************/
...
void ili9881_changepage(mipi_dsi_ctrl_t * const p_api_ctrl, uint8_t page)
{
    ...
    {
        .channel = 0,
        .cmd_id = (mipi_cmd_id_t) MIPI_DSI_CMD_ID_DCS_LONG_WRITE,       /* Cast to mipi_cmd_id_t */
...
void ili9881_cmd_send(mipi_dsi_ctrl_t * const p_api_ctrl, command_type_t * command_flow)
{
    ...
    while (0xFF != command_flow[i].operation)
    {
        ...
        else if (2 == command_flow[i].operation)
        {
            ...
            {
                .channel = 0,
                .cmd_id = (mipi_cmd_id_t)MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,    /* Cast to mipi_cmd_id_t */
                .flags = (mipi_dsi_cmd_flag_t) (MIPI_DSI_CMD_FLAG_LOW_POWER),        /* Cast to mipi_dsi_cmd_flag_t */
                .tx_len = 2,
                .p_tx_buffer = send_data,
            };
