/***********************************************************************************************************************
 * File Name    : mtu3_phase_count_ep.c
 * Description  : Contains data structures and functions used in mtu3_phase_count_ep.c.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
/***********************************************************************************************************************
 * @brief     This function initializes MTU3 driver and start Phase Count.
 * @param[IN] None
 * @retval    FSP_SUCCESS       MTU3 driver opened successfully and start Phase Count.
...
/***********************************************************************************************************************
 * @brief        This function checks that the input address follows the format below.
 ...
 * @param[IN]    input_data[DATA_LENGTH_BYTE * 2]   Input address.
 *               conversionData[DATA_LENGTH_BYTE]   Converted address.
 * @retval       true  : Input address is correct.
...
/***********************************************************************************************************************
 * @brief         This function converts an char array to a hexadecimal array.
 * @param[IN]     input    Char array to be converted.
