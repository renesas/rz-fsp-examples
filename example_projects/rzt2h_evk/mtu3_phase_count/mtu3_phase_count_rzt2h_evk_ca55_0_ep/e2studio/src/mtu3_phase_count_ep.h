...
#define EP_INFO     "\nThis example project demonstrates the use of the Multi-Function Timer Pulse Unit 3 (MTU3)"\
                    "\r\nin phase counting mode on the RZ/T2H microprocessor. It counts pulses from"\
                    "\r\na two-phase encoder (A phase, B phase) and provides Tera Term commands"\
