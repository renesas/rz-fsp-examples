...
5. User can observe the link-up status of all Ethernet ports via messages displayed on Tera Term.
...
7. The board responds to ARP and ICMP Echo requests, allowing users to verify Ethernet functionality by checking successful ping replies.
   ...
   Below images showcases the Ethernet output on Tera Term and Command Prompt:
