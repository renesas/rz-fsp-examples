...
This example project demonstrates Ethernet functionality using the GMAC driver on RZ/T2H based on Renesas FSP.
...
7. The board responds to ARP and ICMP Echo requests, allowing users to verify Ethernet functionality by checking successful ping replies.
   ...
   ![Ethernet_Banner](images/Ethernet_Banner.png "Banner Info")
 
   ![Ethernet_Ping_3_Ports](images/Ethernet_Ping_3_Ports.png "CMD output - Ethernet_Ping_3_Ports")
 
   ![RTT_Ethernet_Ping_Result](images/RTT_Ethernet_Ping_Results.png "RTT output - RTT_Ethernet_Ping_Result")
...
In the figure below:
   ![ETH1_ETH2_new_project](images/ETH1_ETH2_new_project.png "Add ETH1 and ETH2 Info")
...
(2) On the "Properties" tab of PHY, set "PHY-LSI Address" in the red frame in the figure below according to the board to be used.
   ...
   ![set_PHY_LSI_Address](images/set_PHY_LSI_Address.png "Adjust PHY-LSI Address")

For RZ/T2H Evaluation board, set as follows depending on the board version.

|  |  | ETH0 | ETH1 | ETH2 |
|---|---| --- | --- | --- |
| RZ/T2H_EVK | PHY-LSI Address | 0 | 1 | 2|
...
(1) Click ETHSW in the red frame below to select
   ...
   ![ETHSW_select](images/ETHSW_select.png "Select ETHSW substack")

(2) Set "Management port specific tag" to "Enabled" in the "Properties" tab of ETHSW

   ![enabled_management_port_specific_tag](images/enabled_management_port_specific_tag.png "Enabled Management Port Specific Tag")