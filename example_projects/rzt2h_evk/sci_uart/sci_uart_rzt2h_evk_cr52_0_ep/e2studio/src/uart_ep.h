/***********************************************************************************************************************
 * File Name    : uart_ep.h
 * Description  : Contains data structures and functions declarations used in uart_ep.c
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define EP_INFO             "\nThis sample program demonstrates how to use the UART module to send and receive " \
                            "\r\nmessages via the terminal on the RZ/T2H micro controller. The project initializes" \
