...
This example project demonstrates basic functionalities of GPT drive in phase counting mode 1 on RZ/T2H based on Renesas FSP.
...
Result and GPT status are displayed on the J-Link RTT Viewer.
...
## Required Resources
To build and run the GPT Phase Count example project, the following resources are needed.
...
5. Verify phase count direction by rotating the encoder shaft:
   ...
   The images below showcases the GPT output on J-Link RTT Viewer:
