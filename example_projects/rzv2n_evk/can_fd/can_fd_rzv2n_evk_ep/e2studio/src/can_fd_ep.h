...
#define EP_INFO                         "\nThis Example Project demonstrates CAN FD operations on Renesas RZ MPUs using 1 RZ/V board."\
...
extern bool g_canfd_ch0_tx_complete;
extern bool g_canfd_ch0_rx_complete;
