...
/* Global variables */
static uint8_t g_buf[READ_BUF_SIZE] USB_BUFFER_PLACE_IN_SECTION;
...
/***********************************************************************************************************************
 *  @brief      This function prints the message to the console.
...
/***********************************************************************************************************************
 *  @brief      This function checks for write completion.
 *  @param[in]  None.
 *  @retval     FSP_SUCCESS     Upon success.
...
/***********************************************************************************************************************
 *  @brief      This function processes kit information.
 *  @param[in]  None.
 *  @retval     None.
 **********************************************************************************************************************/
static void process_kit_info(void)
