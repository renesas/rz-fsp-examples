...
/* Flag to indicate LCDC frame end event */
static volatile uint8_t flag_lcdc_frameend = 0;
...
/***********************************************************************************************************************
 * @brief     LCDC display callback function: set frame-end flag when DISPLAY_EVENT_FRAME_END occurs.
 * @param[IN] p_args  Callback arguments from the LCDC driver.
 * @retval    None.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief     This function displays eight color band horizontally on Graphical LCD.
 * @param[IN]  None.
 * @retval     None.
 **********************************************************************************************************************/
static void color_band_display(void)
