...
1. Project Overview:
    This Example Project demonstrates the basic functionalities of LCDC device driver on Renesas RZ/A3UL MPUs based on
...
3. Hardware Requirements:
    ...
    1x Parallel to HDMI Conversion board.
    1x Display support HDMI port.
...
5. Hardware Connections:
    ...
    (4) Connect the Parallel-to-HDMI conversion board to port CN5 on the module board for video output.
    (5) Connect a Mini HDMI–to–HDMI cable to the Parallel-to-HDMI conversion board for HDMI signal transmission.
    (6) Connect the Mini HDMI–to–HDMI cable to an HDMI-supported display for video display.
