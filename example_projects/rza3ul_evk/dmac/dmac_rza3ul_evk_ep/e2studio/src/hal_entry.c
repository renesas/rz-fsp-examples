...
void hal_entry(void)
{
    ...
    /* Array to store input from terminal */
    ...
    while (true)
    {
        /* Check for input data from terminal, once data is available read */
        if (APP_CHECK_DATA)
        {
            ...
            /* Consider both input sending type from terminal and checking for valid input */
            ...
            else
            {
                ...
                /* Check for user input to transfer current MTU3 value to destination array */
