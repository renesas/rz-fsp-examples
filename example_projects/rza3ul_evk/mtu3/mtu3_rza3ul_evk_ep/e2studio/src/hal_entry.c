            ...
            switch (read_data)
            {
                case PERIODIC_MODE_TIMER:
                {
                    ...
                    else
                    {
                        ...
                        /* Period Set API set the desired period counts on the PMOD LED */
                ...
                case ONE_SHOT_MODE_TIMER :
                {
                    ...
                    while (true != g_one_shot_expired)
                    {
                        ...
                        {
                            /* We have reached a scenario where One-shot event did not occur */
                    ...
                    if (true == g_one_shot_expired)
                    {
                        ...
                        APP_PRINT("Stopped and reset Timer in ONE-SHOT Mode\r\n");
