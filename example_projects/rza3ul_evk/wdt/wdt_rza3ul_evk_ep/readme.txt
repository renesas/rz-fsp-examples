...
1. Project Overview:
    The example project demonstrates the use of WDT module with the collaboration of IRQ, GTM modules, Pmod BTN,
    and Pmod LED.
    The operation of this EP is described below:
    - Start GTM timer having a callback every 1 second, to refresh WDT and blink the LED (LED0 on Pmod LED).
    - If the BTN0 button (on Pmod BTN) is pressed, IRQ is triggered, the LED (LED0 on Pmod LED) is OFF and
      program is exit.
...
5. Hardware Connections:
    ...
    (4) Connect the Pmod BTN to the PMOD1 CN7 (7:12).
    (5) Connect the Pmod LED to the PMOD0 J1 (7:12).
