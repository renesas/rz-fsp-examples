...
/* Variable to capture the timer counter overflow and print WDT status */
volatile uint32_t g_timer_overflow_counter = RESET_VALUE;

/***********************************************************************************************************************
 * @brief       This function initializes the GTM timer in Periodic mode.
 * @param[in]   None.
...
/***********************************************************************************************************************
 * @brief       This function starts the GTM timer and return the error to the application.
 * @param[in]   None.
 * @retval      FSP_SUCCESS     GTM timer started successfully.
 * @retval      Any other error code apart from FSP_SUCCESS  Unsuccessful to start GTM timer.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       This function closes the GTM timer and handles the return closing API error to the application.
 * @param[in]   None.
 * @retval      None.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       This function is called when GTM timer's counter wrapped around.
...
void gtm_callback(timer_callback_args_t *p_args)
{
    ...
    if (FSP_SUCCESS != err)
    {
        /* Turn ON LED to indicate error, along with output on Tera Term */
