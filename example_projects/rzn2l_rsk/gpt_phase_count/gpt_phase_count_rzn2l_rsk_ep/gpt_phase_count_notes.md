...
This example project demonstrates basic functionalities of GPT drive in phase counting mode 1 on RZ/N2L based on Renesas FSP.
...
## Phase counting mode 1
   ...
   Up-counting and down-counting conditions for phase counting mode 1
...
+ Retrieves the counter value from the initial state of the encoder then rotations clockwise and counterclockwise:
...
+ retrieves the new counter value encoder then rotations clockwise and counterclockwise:
...
+ retrieves the reset counter value encoder then rotations clockwise and counterclockwise:
