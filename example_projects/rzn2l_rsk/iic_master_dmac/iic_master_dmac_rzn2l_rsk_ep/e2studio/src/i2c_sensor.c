...
fsp_err_t init_sensor(void)
{
    ...
    if ((NULL != g_transfer0_ctrl.p_cfg->p_info->p_src) || (NULL != g_transfer0_ctrl.p_cfg->p_info->p_dest))
    {
        APP_ERR_PRINT("** DMAC transfer0 settings init is not NULL ** \r\n");
        return FSP_ERR_INVALID_STATE;
    }
    if ((NULL != g_transfer1_ctrl.p_cfg->p_info->p_src) || (NULL != g_transfer1_ctrl.p_cfg->p_info->p_dest))
    {
