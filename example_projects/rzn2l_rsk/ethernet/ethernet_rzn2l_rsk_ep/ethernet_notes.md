...
This example project demonstrates Ethernet functionality using the GMAC driver on RZ/N2L based on Renesas FSP.
...
7. The board responds to ARP and ICMP Echo requests, allowing users to verify Ethernet functionality by checking successful ping replies.
   ...
   <img src="images/Ethernet_Ping_3_Ports.png" alt="Ethernet_Ping_3_Ports" title="CMD output - Ethernet_Ping_3_Ports" width="800"/>
...
For RZ/N2L RSK board, set as follows depending on the board version.
