...
### Hardware
* 1x Renesas Starter Kit+ for RZ/N2L
* 1x USB A to USB Micro B Cable
* 1x Potentiometer on Renesas Starter Kit+ for RZ/N2L
...
## ADC Value calculation
   ...
   Below images showcases the ADC output on J-Link RTT Viewer:

   ![ADC_Banner](images/ADC_Banner.PNG "Banner Info")
 
   ![ADC_Window_Lower_Limit](images/ADC_Window_Lower_Limit.PNG "RTT output - ADC_Window_Lower_Limit")
 
   ![ADC_values_within_Window_Limits](images/ADC_values_within_Window_Limits.PNG "RTT output - ADC_values_within_Window_Limits")
 
   ![ADC_Window_Upper_Limit](images/ADC_Window_Upper_Limit.PNG "RTT output - ADC_Window_Upper_Limit")
