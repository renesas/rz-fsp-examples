...
fsp_err_t bsc_write_buff(void)
{
    ...
    {
        g_read_data[i] = *((volatile uint16_t * )CS0_BASE + 0x0000 + i);  /* cast to volatile uint16_t */
...
static void nor_Write(uint32_t address, uint16_t data)
{
    ...
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD1) = FLASH_CODE1;
    __asm volatile("dsb");
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD2) = FLASH_CODE2;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD1) = WRITE_CODE;   /* cast to volatile uint16_t */
    __asm volatile("dsb");
    *((volatile uint16_t *)address) = data;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
}
...
static void nor_WriteBuf(uint32_t address, uint16_t *data, uint32_t cnt)
{
    ...
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD2) = FLASH_CODE2;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    *((volatile uint16_t *)sect_addr) = WRITE_BUF_CODE;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    *((volatile uint16_t *)sect_addr) = (uint16_t)(cnt - 1U);  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    for (uint32_t i = 0U; i < cnt; i++)
    {
        *((volatile uint16_t *)address + i) = data[i];  /* cast to volatile uint16_t */
        __asm volatile("dsb");
    }
    __asm volatile("dsb");
    *((volatile uint16_t *)sect_addr) = WRITE_BUF_CODE2;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
}
...
static void nor_StatusGet(uint32_t address, uint32_t * p_status)
{
    ...
    __asm volatile("dsb");
    uint32_t read2 = *(volatile uint16_t*)address; /* cast to volatile uint16_t */
    __asm volatile("dsb");
...
static void nor_Erase(uint32_t address, uint32_t byte_count)
{
    ...
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD2) = FLASH_CODE2;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD1) = ERASE_SECTOR_CODE1;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD1) = FLASH_CODE1;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD2) = FLASH_CODE2;  /* cast to volatile uint16_t */
    __asm volatile("dsb");
    ...
    {
        *((volatile uint16_t *)address)     = ERASE_SECTOR_CODE2;  /* cast to volatile uint16_t */
        __asm volatile("dsb");
    }

    if (CHIP_ERASE == byte_count)
    {
        *((volatile uint16_t *)CS0_BASE + FLASH_A_SEQ_ADD1) = ERASE_SECTOR_CHIP;  /* cast to volatile uint16_t */
        __asm volatile("dsb");
    }
}
