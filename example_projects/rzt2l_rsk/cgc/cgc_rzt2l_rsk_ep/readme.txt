...
1. Project Overview:
    The example project demonstrates the typical use of the CGC HAL module APIs.
    CGC changes the CPU operating clock to lowest setting and LED blinks at slowest clock.
    Then CGC changes the CPU operating clock to fastest setting and LED blinks at fastest clock.
...
4. Hardware Configurations:
    ...
    Hardware Connection:
        ...
        3  *This sample program uses LED.
