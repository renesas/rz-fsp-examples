...
1. Project Overview:
    This example project showcases a typical use case of the Multi-Function Timer Unit 3 (MTU3) on the RZ/T2L microcontroller, 
...
4. Hardware Configurations:
    ...
    Hardware Connection:
        ...
        3. *This sample program uses MTIOC0A P23_7 (RSK board ... JA1-A.21)
        ...
        |  JA1-A header 21 way  |     PWM Output        |
        |-----------------------|-----------------------|
        |     JA1-A-21     <----|---->  MTIOC0A P23_7   |
        |-----------------------|-----------------------|
