...
void hal_entry(void)
{
    ...
    APP_PRINT("\nThis EP performs Ethernet communication with single port ETH2 in the default state\n");
    APP_PRINT("When evaluating simultaneous communication, 1 Ethernet port is required on the HOST PC side\n\n");
