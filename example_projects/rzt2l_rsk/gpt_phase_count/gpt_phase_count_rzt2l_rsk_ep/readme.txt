...
1. Project Overview:
    ...
    RZ/T2L microcontroller. It counts pulses from a two-phase encoder (A phase, B phase) and provides RTT Viewer-based 
...
4. Hardware Configurations:
    ...
    Hardware Connection:
        ...
        4. *Destination Selection JA2-A-13:
        SW7-5: ON, 
        SW7-4: OFF,
        SW7-6: OFF
...
3. Encoder wiring via RS-485 conversion boards (MB057GA140):
   ...
   From the same D+ terminal, route an additional wire to JA2-A-13.
