...
/* Macro for EP info */
#define EP_INFO         "\r\nThe project initializes the SPI driver and configures two SPI channels in Master (CH1)"\
                        "\r\nand Slave mode (CH3) on the RZ/T2L microcontroller. After initialization, the master"\
