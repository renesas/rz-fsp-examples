...
1. Project Overview:
    ...
    This project supports the FIFO feature. In cases where this feature is not used in the application,
    please disable the FIFO feature by the following steps.
    - Set FIFO to Disabled on the UART main stack of the driver in FSP Configuration. 
