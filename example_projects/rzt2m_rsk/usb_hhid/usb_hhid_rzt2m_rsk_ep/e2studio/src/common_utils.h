...
#define EP_INFO         "\r\nThis example project demonstrates basic functionalities of "\
                        "USB Host Human Interface Device \r\n"\
                        "Class (HHID) driver on Renesas RZ MPUs based on Renesas FSP.\r\n"\
