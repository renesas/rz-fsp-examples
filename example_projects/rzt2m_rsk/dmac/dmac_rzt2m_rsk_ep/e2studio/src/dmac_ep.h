/***********************************************************************************************************************
 * File Name    : dmac_ep.h
 * Description  : Contains declarations of data structures and functions used in dmac_ep.c.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define EP_INFO     "\r\nThis example project demonstrates a typical use case of the DMAC module." \
                    ...
                    "\r\ncompare match event." \
                    "\r\nUpon successful completion, the received data is displayed on the RTT Viewer." \
