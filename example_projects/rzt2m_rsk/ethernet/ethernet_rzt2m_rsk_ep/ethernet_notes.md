...
This example project demonstrates Ethernet functionality using the GMAC driver on RZ/T2M based on Renesas FSP.
...
For RZ/T2M RSK board, set as follows depending on the board version.

|  |  | ETH0 | ETH1 | ETH2 |
|---|---| --- | --- | --- |
| RSK MP | PHY-LSI Address | 0 | 1 | 2|
