...
1. Project Overview:
    This sample program demonstrates the use of the Multi-Function Timer Pulse Unit 3 (MTU3) in phase counting mode 1 
    on the RZ/T2M microcontroller. It counts pulses from a two-phase encoder (A phase, B phase) and provides 
...
4. Hardware Configurations:
    ...
    Hardware Connection:
        ...
        6. Connect Two-phase encoder Phase A/B signal with MTU3
...
3. Encoder wiring via RS-485 conversion boards (MB057GA140):
   ...
   From the same D+ terminal, route an additional wire to JA2-A-25.
   Phase B = YELLOW wire: connect to RS-485 conversion board #2 at Encoder CN4 (D+).
   From the same D+ terminal, route an additional wire to JA2-A-26.