...
#define EP_INFO     "\nThis Example project demonstrates the functionality of usb_pcdc driver on Renesas RZ MPUs "\
                    "using RZ/T2M boards."\
                    "\nExecute Tera Term, establish the connection, and configure the parameters "\
                    "to start communication."\
                    "\nPush any key on HostPC via TeraTerm, the character data is displayed on RTT Viewer."\
