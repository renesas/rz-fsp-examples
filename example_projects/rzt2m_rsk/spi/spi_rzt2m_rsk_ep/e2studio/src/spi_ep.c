...
fsp_err_t spi_write_and_read(void)
{
    ...
    while ((SPI_EVENT_TRANSFER_COMPLETE != s_master_event_flag) || (SPI_EVENT_TRANSFER_COMPLETE != s_slave_event_flag))
    {
        ...
        else if ((SPI_EVENT_TRANSFER_ABORTED == s_master_event_flag) ||
                (SPI_EVENT_TRANSFER_ABORTED == s_slave_event_flag))
        {
    ...
    s_master_event_flag = (spi_event_t) RESET_VALUE;  /* Reseting master_event flag */
    s_slave_event_flag  = (spi_event_t) RESET_VALUE;  /* Reseting slave_event flag */
