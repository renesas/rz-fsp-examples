...
/* Macro for EP info */
#define EP_INFO                 "\r\nThe project initializes the SPI driver and configures two SPI channels in Master (CH0)"\
                                "\r\nand Slave mode (CH2) on the RZ/T2M microcontroller. After initialization, the master"\
