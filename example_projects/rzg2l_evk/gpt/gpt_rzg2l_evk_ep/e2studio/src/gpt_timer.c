 ...
 * Description  : Contains data structures and functions used in gpt_timer.c.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
/*****************************************************************************************************************
 * @brief       This function initializes GPT timer.
...
/*****************************************************************************************************************
 * @brief       This function starts GPT timers in periodic, one shot, PWM mode.
 * @param[IN]   p_timer_ctl     Timer instance control structure.
...
fsp_err_t set_timer_duty_cycle(uint8_t duty_cycle_percent)
{
    ...
    /* Cast RESET_VALUE to timer_direction_t to match enum type requirement */
...
/*****************************************************************************************************************
 * @brief      This function closes the GPT HAL driver.
 * @param[IN]  p_timer_ctl     Timer instance control structure.
 * @retval     None.
 ****************************************************************************************************************/
...
/*****************************************************************************************************************
 * @brief      This function prints GPT Timer menu option.
 * @param[IN]  None.
 * @retval     None.
 ****************************************************************************************************************/
...
/*****************************************************************************************************************
 *  @brief      User defined GPT callback function in one-shot mode.
