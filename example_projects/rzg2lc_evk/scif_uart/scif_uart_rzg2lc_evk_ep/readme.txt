...
1. Project Overview:
    ...
    press enter key to set the period of the PMOD LED signal (on LD1). The range of input values are displayed on the
...
5. Hardware Connections:
    ...
    (4) Connect PMOD1 pins 1-6 on the SMARC Carrier Board to the PMOD USBUART.
    (5) Connect J1 on PMOD USBUART with PC.
