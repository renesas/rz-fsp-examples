...
1. Project Overview:
    ...
    interrupt in Interrupt Controller User is requested to press the BTN0 on PMOD BUTTON on Carrier Board to trigger
...
5. Hardware Connections:
    ...
    (4) Connect PMOD1 pins 7–12 on the SMARC Carrier Board to the PMOD BUTTON for button input. 
