...
5. Hardware Connections:
    ...
    (3) Connect Pmod ACL and SMARC Carrier Board as follows.
        ...
        RIICx_SCL/PMOD1 pin 3  ----> SCL (J2.5 on PMOD-ACL)
        RIICx_SDA/PMOD1 pin 4  ----> SDA (J2.6 on PMOD-ACL)
        GND/PMOD1 pin 5        ----> GND (J2.7 on PMOD-ACL)
        VCC/PMOD1 pin 6        ----> VCC (J2.8 on PMOD-ACL)
