...
1. Project Overview:
    The example project demonstrates the use of WDT module with the collaboration of module IRQ, GTM, WDT and
    button/led.
...
5. Hardware Connections:
    ...
    (3) Connect PMOD1 pins 7–12 on the SMARC Carrier Board to the PMOD BUTTON for button input.
