 ...
 * Description  : Contains declarations of data structures and functions used in gpt_timer.c.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define EP_INFO     "\r\nThe project initializes GPT module in Periodic, PWM or One-shot"\
                    ...
                    "\r\nLD0 and LD2 toggle alternately at the configured period."\
                    "\r\nIn PWM mode, user can enter the duty cycle within the "\
                    "\r\nspecified range to control the PWM output."\
                    "\r\nLD0 is driven with PWM at the configured period and duty cycle."\
                    "\r\nIn One-shot mode, the timer runs once and then expires."\
                    "\r\nOn timer expiry, LD0 turns OFF then ON immediately, while LD2 turns ON then"\
