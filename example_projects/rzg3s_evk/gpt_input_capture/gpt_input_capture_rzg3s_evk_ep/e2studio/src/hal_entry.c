...
/***********************************************************************************************************************
 * @addtogroup r_gpt_input_capture_ep
 * @{
 **********************************************************************************************************************/
...
void hal_entry (void)
{
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        APP_ERR_PRINT("** R_GPT_Enable API failed **\r\n");
        APP_ERR_TRAP(err);
    }
    ...
    while (true)
    {
        ...
        if (true == g_b_start_measurement)
        {
            ...
            /* Conversion from float value to string */
            snprintf ((char *)timer_buffer, SIZE_64, "%0.5f", pulse_time);
...
/***********************************************************************************************************************
 * @} (end addtogroup r_gpt_input_capture_ep)
 **********************************************************************************************************************/
