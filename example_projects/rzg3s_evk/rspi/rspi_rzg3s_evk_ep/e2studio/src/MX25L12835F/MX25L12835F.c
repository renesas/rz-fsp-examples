/***********************************************************************************************************************
 * File Name    : MX25L12835F.c
 * Description  : Contains data structures and functions used in MX25L12835F.c.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief      Read the chip id and verify that the flash module is connected properly.
 * @param[IN]  p_drv Driver for communicating with the MX25L12835F.
 * @retval     MX25L12835F_SUCCES        Upon successful read and verify.
 * @retval     MX25L12835F_RDID_MISMATCH mismatch chip ID.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief      Erase an entire sector on the device.
 * @param[IN]  p_drv           Driver for communicating with the MX25L12835F.
 ...
 * @param[IN]  data            Pointer to store the data in.
...
/***********************************************************************************************************************
 * @brief      Send the rdid command in order to retrieve the chip id.
 * @param[IN]  p_drv           Driver for communicating with the MX25L12835F.
 * @param[IN]  id              Pointer to the id variable to store the chip id.
 * @retval     MX25L12835F_SUCCESS  The sector was erased correctly.
 * @retval     MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
static mx25l1235f_status_t cmd_rdid (mx25l1235f_drv_t * const p_drv, uint32_t * id)
...
/***********************************************************************************************************************
 * @brief       Send the wren command in order to set the write enable latch.
 * @param[IN]   p_drv           Driver for communicating with the MX25L12835F.
 * @retval      MX25L12835F_SUCCESS  The sector was erased correctly.
 * @retval      MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief         Send the rdsr command in order to read the status register.
 * @param[IN]     p_drv           Driver for communicating with the MX25L12835F.
 * @param[IN]     status          Pointer to the variable to store the status register in.
 * @retval        MX25L12835F_SUCCESS  The sector was erased correctly.
 * @retval        MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
static mx25l1235f_status_t cmd_rdsr (mx25l1235f_drv_t * const p_drv, uint8_t * status)
...
/***********************************************************************************************************************
 * @brief       Send the read command in order to get data from the flash module.
 * @param[IN]   p_drv           Driver for communicating with the MX25L12835F.
 * @param[IN]   addr            Start address to get data from the MX25L12835F.
 * @param[IN]   data            Pointer to store data in.
 * @param[IN]   length          Number of bytes to read.
 * @retval      MX25L12835F_SUCCESS  The sector was erased correctly.
 * @retval      MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       Send a page program command in order to write a single page of data.
 * @param[IN]   p_drv           Driver for communicating with the MX25L12835F.
 * @param[IN]   addr            Start address of the page to program.
 * @param[IN]   data            Pointer to the data to write to the page.
