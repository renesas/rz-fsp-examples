...
/***********************************************************************************************************************
 * @brief       This function initialize the GTM timer in periodic mode.
 * @param[IN]   None.
...
fsp_err_t init_gtm_module(void)
{
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        APP_ERR_PRINT("** R_GTM_Open API failed **\r\n");
    }
...
/***********************************************************************************************************************
 * @brief       This function start the GTM HAL timer and return the error to the application.
 * @param[IN]   None.
...
/***********************************************************************************************************************
 * @brief       This function close the GTM HAL driver and Handle the return closing API error, to the application.
 * @param[IN]   None.
 * @retval      None.
 **********************************************************************************************************************/
...
void gtm_callback(timer_callback_args_t *p_args)
{
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        /* Print Error on J-Link RTT Viewer console */
        APP_ERR_PRINT("** R_WDT_Refresh API failed **\r\n");
    }
    else
    {
