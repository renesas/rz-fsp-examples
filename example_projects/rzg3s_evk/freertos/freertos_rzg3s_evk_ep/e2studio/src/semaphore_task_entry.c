...
/***********************************************************************************************************************
 * @brief      : Wait for and acquire semaphore released by GTM timer; handle stop/close events on suspend.
 * @param[IN]  : pvParameters    Pointer to the parameters passed to the task.
 * @return     : None.
 **********************************************************************************************************************/
