...
5. Hardware Connections:
    ...
    (3) Connect PMOD LED to Pmod Type3/3A(CN3) (pin 1-6) on RZ/V2H EVK Expansion Board.
    (4) Connect RZ/V2H EVK Expansion Board and 2 CAN transceiver modules:
            Signal connections:
            +-------------------------------+-------------------------+-------------------------+
            | RZ/V2H EVK Expansion Board    | CAN Transceiver 1       | CAN Transceiver 2       |
            +-------------------------------+-------------------------+-------------------------+
