...
/* Flag used to trigger WDT system reset */
volatile bool g_system_reset_flag = false;
...
/***********************************************************************************************************************
 * This function is called to enable WDT System Reset.
 * @brief       Enable WDT System Reset.
 * @param[IN]   None
 * @retval      None
 **********************************************************************************************************************/
static void procedure_system_reset(void)
{
    /* Enable WDT System Reset */
    R_BSP_WDT_SYSTEM_RESET_ENABLE(g_wdt_cfg_extend.channel, g_system_reset_flag);
}
