...
1. Project Overview:
    ...
    Viewer. Any failure will also be displayed using J-Link RTT Viewer. To see user input values on Serial terminal, 
...
5. Hardware Connections:
    ...
    (3) Connect PMOD0 pins 7–12 on the SMARC Carrier Board to the PMOD LED for LED output control (LD2).
        ...
        Connect J1 on Pmod USBUART with PC using a Type-A to micro USB cable.
...
1. For Serial terminal application:
   ...
   1.2 The configuration parameters of the serial port on the terminal application are as follows:
        COM port is port provided by the PMOD USBUART.
