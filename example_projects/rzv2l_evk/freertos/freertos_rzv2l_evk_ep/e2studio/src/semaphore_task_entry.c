 ...
 * Description  : Wait for and acquire semaphore released by GTM timer; handle stop/close events on suspend.
...
void semaphore_task_entry(void *pvParameters)
{
    ...
    /* Start GTM timer to 'Give' Semaphore periodically at 1 second for semaphore_task. */
 ...
 * Description  : User defined GTM IRQ callback for Semaphore.
 * @param[in]   : p_args
 * Return Value : None
 **********************************************************************************************************************/
