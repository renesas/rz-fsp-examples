...
5. Hardware Connections:
    ...
    (3) Connect Pmod ACL and SMARC Carrier Board using jumper wires as follows.
        Pmod ACL has two on board connectors, J2 is used for I2C communication.
        RIICx_SCL/PMOD0_2A pin 10 ----> SCL (J2:5 on PMOD-ACL)
        RIICx_SDA/PMOD1_3A pin 9  ----> SDA (J2:6 on PMOD-ACL)
        GND/PMOD1_3A pin 11       ----> GND (J2:7 on PMOD-ACL)
        VCC/PMOD1_3A pin 12       ----> VCC (J2:8 on PMOD-ACL)

Note:
1. Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x0002d668
