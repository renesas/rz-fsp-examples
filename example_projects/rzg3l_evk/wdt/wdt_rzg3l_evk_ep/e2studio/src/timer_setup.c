...
volatile uint8_t g_timer_overflow_counter = RESET_VALUE;
...
/***********************************************************************************************************************
 * @brief       This function starts the GTM HAL timer and return the error to the application.
 * @param[IN]   None.
...
/***********************************************************************************************************************
 * @brief       This function closes the GTM HAL driver and Handle the return closing API error, to the application.
 * @param[IN]   None.
 * @retval      None.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       This function is called when the GTM timer counter wraps around to refresh the WDT counter
