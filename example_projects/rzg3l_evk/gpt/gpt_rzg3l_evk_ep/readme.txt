...
1. Project Overview:
    ...
    LD1 and LD3 toggle alternately at the configured period. In PWM mode, user can enter the duty cycle within the
    ...
    LD1 turns ON then OFF immediately (opposite states).
...
5. Hardware Connections:
    ...
    (3) Connect PMOD0-2A pins 1–6 on the SMARC Carrier Board to the PMOD LED for LED output control. 

Note:
1. Timer period range in millisecond as per Example Project configuration:
   RZ/G3L      --      (0 to 42949) ms
