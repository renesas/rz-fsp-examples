...
1. Project Overview:
    ...
    in Interrupt Controller User is requested to press the USER_SW3 push button on Carrier Board to trigger
    the external IRQ and this then will start toggling of user LED (LD0 on PMOD LED).
