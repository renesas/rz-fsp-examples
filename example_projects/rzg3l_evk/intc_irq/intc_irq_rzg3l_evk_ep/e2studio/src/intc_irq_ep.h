...
#define USER_SW_IRQ_NUMBER        (0x05)        /* Channel 5 */
#define LED_BLINK                 (0U)          /* Index of the LED to toggle */
...
#define EP_INFO     "\r\nThe example project demonstrates the typical use of the INTC IRQ module APIs.\r\n"\
                    ...
                    "the USER_SW3 push button on Carrier Board to trigger the external IRQ and this then\r\n"\
                    "will start toggling of user LED (LD0 on PMOD LED).\r\n"
