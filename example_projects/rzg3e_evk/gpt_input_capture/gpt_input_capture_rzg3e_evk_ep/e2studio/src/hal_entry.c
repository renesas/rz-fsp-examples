...
#define EP_INFO         "\r\nThe example project demonstrates the functionality of GPT Input\r\n"\
                        ...
                        "(GPT3). GPT3 counts the event pulse received at its input. Based\r\n"\
...
/* Global variables */
volatile bool g_b_start_measurement = false;
...
void hal_entry(void)
{
    ...
    while (true)
    {
        ...
        if (true == g_b_start_measurement)
        {
            /* Reset the flag */
            g_b_start_measurement = false;
            ...
            snprintf((char *)timer_buffer, SIZE_64, "%0.5f", pulse_time);  /* Cast float to char type */
...
/***********************************************************************************************************************
 * @brief       This function is user defined callback.
 * @param[IN]   p_args.
 * @retval      None.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       This function de-initializes GPT module.
