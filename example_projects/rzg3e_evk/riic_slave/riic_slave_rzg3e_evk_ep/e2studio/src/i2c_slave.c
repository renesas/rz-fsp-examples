...
/***********************************************************************************************************************
 * @brief This function initializes RIIC Master and Slave drivers.
 * @param[IN] None
...
fsp_err_t init_i2c_driver(void)
{
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        {
            /* Display failure message in RTT */
            APP_ERR_PRINT("\r\n** R_RIIC_MASTER_Close API failed **\r\n");
        }
    }
    return err;
}
...
/***********************************************************************************************************************
 *  @brief      This function performs slave write-read operations and toggles LEDs on successful operation.
    ...
    switch (g_slave_rw)
    {
        case SLAVE_READ:
        {
            ...
            if (FSP_SUCCESS != error)
            {
                ...
                /* Print RTT message. */
                APP_ERR_PRINT("** iic_slave_read failed **\r\n");
            }
            else
            {
        ...
        case SLAVE_WRITE:
        {
            ...
            if (FSP_SUCCESS != error)
            {
                ...
                /* Print RTT message */
                APP_ERR_PRINT("** iic_slave_write failed **\r\n");
            }
            else
            {
                /* Toggle LED as sign of success*/
...
/***********************************************************************************************************************
 *  @brief       This function performs the slave write operation.
 *  @param[in]   None
...
/***********************************************************************************************************************
 *  @brief      This function performs the slave read operation.
 *  @param[in]  None.
...
static fsp_err_t iic_slave_read (void)
{
    ...
    {
        APP_ERR_PRINT("\r\n** R_RIIC_MASTER_Write API failed **\r\n");
        return read_err;
    }
...
/***********************************************************************************************************************
 *  @brief        This function is the user-defined master callback.
 *  @param[in]    p_args
 *  @retval       None
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 *  @brief        This function is the user-defined slave callback.
 *  @param[in]    p_args
 *  @retval       None
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief This function toggles on-board LEDs that are connected and supported by BSP.
 * @param[in] None
 * @retval    None
 **********************************************************************************************************************/
static void toggle_led (void)
...
/***********************************************************************************************************************
 *  @brief       This function turns on-board LEDs on or off.
...
/***********************************************************************************************************************
 * @brief       This function closes the RIIC Master and Slave modules and handles errors with proper RTT messages.
 * @param[in]   None
 * @retval      None
 **********************************************************************************************************************/
