...
1. Project Overview:
    ...
    User is requested to press the "SLEEP" push button on Carrier Board to trigger the external IRQ 
    and this then will start toggling of user LED (LD2 on PMOD LED).
