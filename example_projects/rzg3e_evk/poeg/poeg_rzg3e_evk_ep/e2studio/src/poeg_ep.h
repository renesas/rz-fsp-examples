...
#define EP_INFO "\r\nThe example project demonstrates the basic functionalities of "\
                "\r\nPOEG driver on Renesas RZG MPU based on Renesas FSP RZG MPUs is "\
...
/* Available user-controllable LEDs on this board */
/* These enums can be can be used to index into the array of LED pins found in the bsp_leds_t structure */
typedef enum e_led
{
    LED_LED0,                      ///< LED0
    LED_LED1,                      ///< LED1
