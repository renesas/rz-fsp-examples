...
1. Project Overview:
    ...
    User is requested to press the USER_SW1 push button on Carrier Board to trigger the external IRQ and this then will 
    start toggling of user LED (LD2 on PMOD LED).
...
5. Hardware Connections:
    ...
    (3) Connect PMOD1_6A (PIN7-12) on the SMARC Carrier Board to the PMOD LED for LED output control.

Note:
1. Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x08006de0
