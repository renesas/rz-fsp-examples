...
/***********************************************************************************************************************
 * @brief       Initialize and verify the flash module connection.
 *              Reads the chip ID to ensure the device is connected and responding correctly.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
 * @retval      MX25L12835F_SUCCESS         Initialization successful.
 * @retval      MX25L12835F_RDID_MISMATCH   Chip ID does not match.
 * @retval      MX25L12835F_ERROR           Communication error occurred.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       Erase an entire sector on the flash device.
 *              Sends Write Enable, monitors the Write Enable Latch (WEL) bit, issues the erase command,
 *              and polls the Write In Progress (WIP) bit until the operation completes.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
 * @param[in]   addr             The start address of the sector to be erased.
 * @retval      MX25L12835F_SUCCESS  Sector was erased successfully.
 * @retval      MX25L12835F_ERROR    An error occurred during communication or execution.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       Programs a page on the device.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
 * @param[in]   start_addr       The start address.
 * @param[in]   data             Pointer to data to be written to the page.
 * @param[in]   length           The number of bytes to write.
 * @retval      MX25L12835F_SUCCESS  Operation completed successfully.
 ...
 * @param[out]  data             Pointer to store the data in.
 * @param[in]   length           Number of bytes to read.
 * @retval      MX25L12835F_SUCCESS  Read operation successful.
 * @retval      MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       Restore the driver to its initial state.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
 * @retval      MX25L12835F_SUCCESS  Teardown successful.
 * @retval      MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       Send the RDID command to retrieve the chip ID.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
 * @param[out]  id               Pointer to store the retrieved chip ID.
 * @retval      MX25L12835F_SUCCESS  Command executed successfully.
 * @retval      MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
static mx25l1235f_status_t cmd_rdid (mx25l1235f_drv_t * const p_drv, uint32_t * id)
{
...
/***********************************************************************************************************************
 * @brief       Send the WREN command to set the write enable latch.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
 * @retval      MX25L12835F_SUCCESS  Command executed successfully.
 * @retval      MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief       Send the RDSR command to read the status register.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
...
/***********************************************************************************************************************
 * @brief       Send the erase command to erase a sector on the module.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
...
static mx25l1235f_status_t cmd_erase (mx25l1235f_drv_t * const p_drv, uint32_t addr)
{
    ...
    uint8_t erase_tx[4] = {FLASH_CMD_SE, (addr >> 16) & 0xFF, (addr >> 8) & 0xFF, (addr >> 0) & 0xFF}; 
...
/***********************************************************************************************************************
 * @brief       Send the read command to retrieve data from the flash module.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
 * @param[in]   addr             Start address to read from.
 * @param[out]  data             Pointer to store retrieved data.
 * @param[in]   length           Number of bytes to read.
 * @retval      MX25L12835F_SUCCESS  Command executed successfully.
 * @retval      MX25L12835F_ERROR    An error occurred.
 **********************************************************************************************************************/
static mx25l1235f_status_t cmd_read (mx25l1235f_drv_t * const p_drv, uint32_t addr, uint8_t * data, uint32_t length)
{
    ...
    uint8_t read_tx[4] = {FLASH_CMD_READ, (addr >> 16) & 0xFF, (addr >> 8) & 0xFF, (addr >> 0) & 0xFF}; 
...
/***********************************************************************************************************************
 * @brief       Send the page program command to write a page of data.
 * @param[in]   p_drv            Pointer to the MX25L12835F driver instance.
                                             ...
                                             uint32_t                 length)
{
    ...
    uint8_t cmd_tx[4] = {FLASH_CMD_PP, (addr >> 16) & 0xFF, (addr >> 8) & 0xFF, (addr >> 0) & 0xFF}; 
