...
/***********************************************************************************************************************
 *  @brief       This is UART Example project to demonstrate the functionality.
 *  @param[in]   None.
...
/***********************************************************************************************************************
 *  @brief       This function prints user message to terminals.
 *  @param[in]   p_msgs.
 *  @retval      FSP_SUCCESS                Upon success.
 *  @retval      FSP_ERR_TRANSFER_ABORTED   Upon event failures.
 *  @retval      Any other error code apart from FSP_SUCCESS, unsuccessful write operations.
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 *  @brief       This function de-initializes SCI_B UART module.
 *  @param[in]   None.
 *  @retval      None.
 **********************************************************************************************************************/
